...
namespace Command.UI
{
    public class UIService : MonoBehaviour
    {
        ...
        public void ShowActionSelectionView(List<CommandType> executableActions)
        {
            ...
            {
                case Replay.ReplayState.ACTIVATED:
                    GameService.Instance.StartCoroutine(GameService.Instance.ReplayService.ExecuteNext()); break;

                case Replay.ReplayState.DEACTIVATED:
